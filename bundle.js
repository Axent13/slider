...
// Module
exports.push([module.i, "* {\n  box-sizing: border-box;\n  margin: 0;\n  padding: 0; }\n\nhtml {\n  font-size: 14px; }\n\n.slider-page {\n  max-width: 80%;\n  margin: 9rem auto 0; }\n  .slider-page__slider-container {\n    margin-bottom: 5rem; }\n  .slider-page__slider-container-first {\n    width: 60%;\n    height: 0.65rem; }\n  .slider-page__slider-container-second {\n    width: 30%;\n    height: 1.3rem; }\n  .slider-page__slider-container-third {\n    width: 80%;\n    height: 3rem; }\n", ""]);
// Exports
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/slider/slider.scss":
/*!*************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/slider/slider.scss ***!
  \*************************************************************************************************************/
/*! no static exports found */
...
/* harmony import */ var _slider_slider_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./slider/slider.scss */ "./src/slider/slider.scss");
/* harmony import */ var _slider_slider_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_slider_slider_scss__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _favicons_favicons__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./favicons/favicons */ "./src/favicons/favicons.js");
/* harmony import */ var _favicons_favicons__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_favicons_favicons__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _slider_Presenter_presenter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./slider/Presenter/presenter */ "./src/slider/Presenter/presenter.ts");




var $sliderContainers = ('.js-slider-page__slider-container');
var sliderOptions = {
    minValue: 0,
    maxValue: 100,
    step: 10,
};
$($sliderContainers).each(function (index, node) {
    new _slider_Presenter_presenter__WEBPACK_IMPORTED_MODULE_3__["default"](node, sliderOptions);
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Observer_observer_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Observer/observer.ts */ "./src/slider/Observer/observer.ts");
...
var Model = /** @class */ (function (_super) {
    ...
    function Model(options) {
        ...
        _this.maxValue = options.maxValue || 100;
        _this.range = _this.maxValue - _this.minValue;
        _this.startSelectedValue = options.startSelectedValue || _this.range / 4;
        _this.endSelectedValue = options.endSelectedValue || _this.range - _this.range / 4;
        return _this;
    }
    Model.prototype.getMinValue = function () {
        return this.minValue;
    };
    Model.prototype.getMaxValue = function () {
        return this.maxValue;
    };
    Model.prototype.getRange = function () {
        return this.range;
    };
    Model.prototype.getStartSelectedValue = function () {
        return this.startSelectedValue;
    };
    Model.prototype.getEndSelectedValue = function () {
        return this.endSelectedValue;
    };
    Model.prototype.setMinValue = function (newValue) {
        this.minValue = newValue;
        this.setRange(this.minValue, this.maxValue);
    };
    Model.prototype.setMaxValue = function (newValue) {
        this.maxValue = newValue;
        this.setRange(this.minValue, this.maxValue);
    };
    Model.prototype.setRange = function (newMinValue, newMaxValue) {
        this.range = newMaxValue - newMinValue;
    };
    Model.prototype.setStartSelectedValue = function (newValue) {
        this.startSelectedValue = newValue;
        this.emit({ type: 'modelUpdatedStartSelectedValue', data: this.startSelectedValue });
    };
    Model.prototype.setEndSelectedValue = function (newValue) {
        this.endSelectedValue = newValue;
        this.emit({ type: 'modelUpdatedEndSelectedValue', data: this.endSelectedValue });
    };
    return Model;
}(_Observer_observer_ts__WEBPACK_IMPORTED_MODULE_0__["default"]));
/* harmony default export */ __webpack_exports__["default"] = (Model);


/***/ }),

/***/ "./src/slider/Observer/observer.ts":
/*!*****************************************!*\
  !*** ./src/slider/Observer/observer.ts ***!
  \*****************************************/
/*! exports provided: default */
...
var Observer = /** @class */ (function () {
    ...
    Observer.prototype.emit = function (action) {
...
/***/ "./src/slider/Presenter/presenter.ts":
/*!*******************************************!*\
  !*** ./src/slider/Presenter/presenter.ts ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _Model_model_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Model/model.ts */ "./src/slider/Model/model.ts");
/* harmony import */ var _View_view_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../View/view.ts */ "./src/slider/View/view.ts");


var Presenter = /** @class */ (function () {
    function Presenter($rootElement, options) {
        this.$rootElement = $rootElement;
        this.step = 1 / options.step;
        this.model = new _Model_model_ts__WEBPACK_IMPORTED_MODULE_0__["default"]({
            minValue: options.minValue,
            maxValue: options.maxValue,
        });
        this.view = new _View_view_ts__WEBPACK_IMPORTED_MODULE_1__["default"]($rootElement);
        this.model.subscribe(this);
        this.view.subscribe(this);
        this.setInitialViewValues();
    }
    Presenter.prototype.setInitialViewValues = function () {
        var startValue = this.model.getStartSelectedValue();
        var endValue = this.model.getEndSelectedValue();
    ...
    Presenter.prototype._pixelsToValue = function (pixels) {
        var sliderWidth = $(this.$rootElement).width() || 0;
    ...
    Presenter.prototype._valueToPixels = function (value) {
        var sliderWidth = $(this.$rootElement).width() || 0;
    ...
    Presenter.prototype.update = function (action) {
        switch (action.type) {
            case 'sliderClickedCloserToStartPoint': {
                var newValue = this._pixelsToValue(action.data);
            ...
            case 'modelUpdatedStartSelectedValue': {
                var newValue = this._valueToPixels(action.data);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _Observer_observer_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Observer/observer.ts */ "./src/slider/Observer/observer.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var View = /** @class */ (function (_super) {
    ...
    function View($rootElement) {
        ...
        _this.$sliderElement = View.createSliderElement();
        _this.$sliderValuesElement = View.createSliderValuesElement();
        _this.$startLimitValueElement = View.createStartLimitValueElement();
        _this.$sliderValuesElement.append(_this.$startLimitValueElement);
        _this.$delimiterElement = View.createDelimeterElement();
        _this.$sliderValuesElement.append(_this.$delimiterElement);
        _this.$endLimitValueElement = View.createEndLimitValueElement();
        _this.$sliderValuesElement.append(_this.$endLimitValueElement);
        _this.$sliderElement.append(_this.$sliderValuesElement);
        _this.$backgroundLineElement = View.createBackgroundLineElement();
        _this.$rangeLineElement = View.createRangeLineElement();
        _this.$startPointElement = View.createStartPointElement();
        _this.$startTipElement = View.createStartTipElement();
        _this.$startPointElement.append(_this.$startTipElement);
        _this.$endPointElement = View.createEndPointElement();
        _this.$endTipElement = View.createEndTipElement();
        _this.$endPointElement.append(_this.$endTipElement);
        _this.$rangeLineElement.append(_this.$startPointElement);
        _this.$rangeLineElement.append(_this.$endPointElement);
        _this.$backgroundLineElement.append(_this.$rangeLineElement);
        _this.$sliderElement.append(_this.$backgroundLineElement);
        _this.$rootElement.append(_this.$sliderElement);
        _this._handleSliderClick = _this._handleSliderClick.bind(_this);
        _this._handleStartPointMouseDown = _this._handleStartPointMouseDown.bind(_this);
        _this._handleStartPointMouseMove = _this._handleStartPointMouseMove.bind(_this);
        _this._handleStartPointMouseUp = _this._handleStartPointMouseUp.bind(_this);
        _this._handleEndPointMouseDown = _this._handleEndPointMouseDown.bind(_this);
        _this._handleEndPointMouseMove = _this._handleEndPointMouseMove.bind(_this);
        _this._handleEndPointMouseUp = _this._handleEndPointMouseUp.bind(_this);
        _this._initEventListeners();
        return _this;
    }
    View.createSliderElement = function () {
        var $sliderElement = document.createElement('div');
        $sliderElement.classList.add('slider');
        return $sliderElement;
    };
    View.createSliderValuesElement = function () {
        var $sliderValuesElement = document.createElement('div');
        $sliderValuesElement.classList.add('slider__values');
        return $sliderValuesElement;
    };
    View.createStartLimitValueElement = function () {
        var $startLimitValueElement = document.createElement('span');
        $startLimitValueElement.classList.add('slider__start-limit-value', 'js-slider__start-limit-value');
        return $startLimitValueElement;
    };
    View.createDelimeterElement = function () {
        var $delimiterElement = document.createElement('span');
        $delimiterElement.classList.add('slider__delimiter');
        return $delimiterElement;
    };
    View.createEndLimitValueElement = function () {
        var $endLimitValueElement = document.createElement('span');
        $endLimitValueElement.classList.add('slider__end-limit-value', 'js-slider__end-limit-value');
        return $endLimitValueElement;
    };
    View.createBackgroundLineElement = function () {
        var $backgroundLineElement = document.createElement('div');
        $backgroundLineElement.classList.add('slider__background-line');
        return $backgroundLineElement;
    };
    View.createRangeLineElement = function () {
        var $rangeLineElement = document.createElement('div');
        $rangeLineElement.classList.add('slider__range-line', 'js-slider__range-line');
        return $rangeLineElement;
    };
    View.createStartPointElement = function () {
        var $startPointElement = document.createElement('div');
        $startPointElement.classList.add('slider__point', 'slider__point_position_start', 'js-slider__point_position_start');
        return $startPointElement;
    };
    View.createStartTipElement = function () {
        var $startTipElement = document.createElement('div');
        $startTipElement.classList.add('slider__tip', 'slider__tip_position_start', 'js-slider__tip_position_start');
        return $startTipElement;
    };
    View.createEndPointElement = function () {
        var $endPointElement = document.createElement('div');
        $endPointElement.classList.add('slider__point', 'slider__point_position_end', 'js-slider__point_position_end');
        return $endPointElement;
    };
    View.createEndTipElement = function () {
        var $endTipElement = document.createElement('div');
        $endTipElement.classList.add('slider__tip', 'slider__tip_position_end', 'js-slider__tip_position_end');
        return $endTipElement;
    };
    View.prototype.setStartPointPosition = function (coordinate) {
        $(this.$rangeLineElement).css('left', coordinate + "px");
    };
    View.prototype.setStartTipValue = function (value) {
        $(this.$startTipElement).text(value);
    };
    View.prototype.setStartLimitValue = function (value) {
        $(this.$startLimitValueElement).text(value);
    };
    View.prototype.setEndPointPosition = function (coordinate) {
        $(this.$rangeLineElement).css('right', coordinate + "px");
    };
    View.prototype.setEndTipValue = function (value) {
        $(this.$endTipElement).text(value);
    };
    View.prototype.setEndLimitValue = function (value) {
        $(this.$endLimitValueElement).text(value);
    };
    View.prototype._handleSliderClick = function (event) {
        var _a;
        console.log('Slider clicked!');
        var sliderStartCoordinate = ((_a = $(this.$backgroundLineElement).offset()) === null || _a === void 0 ? void 0 : _a.left) || 0;
        var sliderWidth = $(this.$rootElement).width() || 0;
        var sliderEndCoordinate = sliderStartCoordinate + sliderWidth;
        // Вычисляю координаты середины выделенной области слайдера,
        // чтобы определить, ближе к какому из бегунков был совершен клик
        var startPointCoordinate = parseInt($(this.$rangeLineElement).css('left'), 10) + sliderStartCoordinate;
        var rangeLineWidth = $(this.$rangeLineElement).width() || 0;
        var rangeLineCenterCoordinate = startPointCoordinate + rangeLineWidth / 2;
        if (event.pageX <= rangeLineCenterCoordinate) {
            var newPosition = event.pageX - sliderStartCoordinate;
            if (newPosition >= 0) {
                this.emit({ type: 'sliderClickedCloserToStartPoint', data: newPosition });
            }
        }
        else {
            var newPosition = sliderEndCoordinate - event.pageX;
            if (newPosition >= 0) {
                this.emit({ type: 'sliderClickedCloserToEndPoint', data: newPosition });
            }
        }
    };
    View.prototype._handleStartPointMouseDown = function () {
        $(document).on('mousemove', this._handleStartPointMouseMove);
        $(document).on('mouseup', this._handleStartPointMouseUp);
    };
    View.prototype._handleStartPointMouseMove = function (event) {
        var _a;
        var sliderStartCoordinate = ((_a = $(this.$rootElement).offset()) === null || _a === void 0 ? void 0 : _a.left) || 0;
        var newPosition = event.pageX - sliderStartCoordinate;
        var sliderWidth = $(this.$rootElement).width() || 0;
        var endPointCoordinate = sliderWidth - parseInt($(this.$rangeLineElement).css('right'), 10);
        if (newPosition <= 0) {
            newPosition = 0;
        }
    ...
    View.prototype._handleStartPointMouseUp = function () {
        $(document).off('mousemove', this._handleStartPointMouseMove);
        $(document).off('mouseup', this._handleStartPointMouseUp);
    };
    View.prototype._handleEndPointMouseDown = function () {
        $(document).on('mousemove', this._handleEndPointMouseMove);
        $(document).on('mouseup', this._handleEndPointMouseUp);
    };
    View.prototype._handleEndPointMouseMove = function (event) {
        var _a;
        var sliderWidth = $(this.$rootElement).width() || 0;
        var sliderStartCoordinate = ((_a = $(this.$rootElement).offset()) === null || _a === void 0 ? void 0 : _a.left) || 0;
        var sliderEndCoordinate = sliderStartCoordinate + sliderWidth;
        var newPosition = sliderEndCoordinate - event.pageX;
        var startPointCoordinate = sliderWidth - parseInt($(this.$rangeLineElement).css('left'), 10);
        if (newPosition <= 0) {
            newPosition = 0;
        }
...
var api = __webpack_require__(/*! ../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
            var content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js!../../node_modules/sass-loader/dist/cjs.js!./slider.scss */ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/slider/slider.scss");
